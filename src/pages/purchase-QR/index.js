    ...
    return (
        <SafeAreaView style={CONSTANTS.container}>
            <View style={CONSTANTS.container}>
                ...
                {openQR && <View style={{ flex: 1, justifyContent: 'center', backgroundColor: CONSTANTS.COLORS.WHITE }}>
                    <QRCodeScanner
                        onRead={scanQr}
                    />
                </View>}
                {!openQR && <View style={{ flex: 1, justifyContent: 'center', backgroundColor: CONSTANTS.COLORS.WHITE }}>
                    <Text style={{ textAlign: 'center', fontSize: 25, fontWeight: 'bold' }}> Scan QR Code </Text>
                </View>}
            </View>
        </SafeAreaView>
    );
